# Code book for Coursera *Getting and Cleaning Data* course project on week 4
...
The `tidy_data.txt` data file is a text file, containing pipe-separated values.
...
1. Download zip and extract, loading data sets into memory
